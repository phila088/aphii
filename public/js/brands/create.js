window.onload = function () {
    ...
    Ke.addEventListener("change", () => {
        ...
        document.addEventListener('livewire:initialized', () => {
            document.querySelector('[id^="save-"]').addEventListener("click", (e) => {
                ($wire.office_hours_monday_open !== w.value) ? w.value : null,
                    ($wire.office_hours_monday_close !== p.value) ? p.value : null,
                    ($wire.office_hours_tuesday_open !== f.value) ? f.value : null,
                    ($wire.office_hours_tuesday_close !== S.value) ? S.value : null,
                    ($wire.office_hours_wednesday_open !== q.value) ? q.value : null,
                    ($wire.office_hours_wednesday_close !== g.value) ? g.value : null,
                    ($wire.office_hours_thursday_open !== $.value) ? $.value : null,
                    ($wire.office_hours_thursday_close !== E.value) ? E.value : null,
                    ($wire.office_hours_friday_open !== L.value) ? L.value : null,
                    ($wire.office_hours_friday_close !== z.value) ? z.value : null,
                    ($wire.office_hours_saturday_open !== A.value) ? A.value : null,
                    ($wire.office_hours_saturday_close !== j.value) ? j.value : null,
                    ($wire.office_hours_sunday_open !== x.value) ? x.value : null,
                    ($wire.office_hours_sunday_close !== D.value) ? D.value : null,
                    ($wire.service_hours_monday_open !== I.value) ? I.value : null,
                    ($wire.service_hours_monday_close !== J.value) ? J.value : null,
                    ($wire.service_hours_tuesday_open !== K.value) ? K.value : null,
                    ($wire.service_hours_tuesday_close !== M.value) ? M.value : null,
                    ($wire.service_hours_wednesday_open !== N.value) ? N.value : null,
                    ($wire.service_hours_wednesday_close !== O.value) ? O.value : null,
                    ($wire.service_hours_thursday_open !== Q.value) ? Q.value : null,
                    ($wire.service_hours_thursday_close !== R.value) ? R.value : null,
                    ($wire.service_hours_friday_open !== U.value) ? U.value : null,
                    ($wire.service_hours_friday_close !== V.value) ? V.value : null,
                    ($wire.service_hours_saturday_open !== W.value) ? W.value : null,
                    ($wire.service_hours_saturday_close !== X.value) ? X.value : null,
                    ($wire.service_hours_sunday_open !== Y.value) ? Y.value : null,
                    ($wire.service_hours_sunday_close !== Z.value) ? Z.value : null,
                    ($wire.after_hours_monday_open !== de.value) ? de.value : null,
                    ($wire.after_hours_monday_close !== ce.value) ? ce.value : null,
                    ($wire.after_hours_tuesday_open !== te.value) ? te.value : null,
                    ($wire.after_hours_tuesday_close !== oe.value) ? oe.value : null,
                    ($wire.after_hours_wednesday_open !== ne.value) ? ne.value : null,
                    ($wire.after_hours_wednesday_close !== ye.value) ? ye.value : null,
                    ($wire.after_hours_thursday_open !== ie.value) ? ie.value : null,
                    ($wire.after_hours_thursday_close !== _e.value) ? _e.value : null,
                    ($wire.after_hours_friday_open !== he.value) ? he.value : null,
                    ($wire.after_hours_friday_close !== ke.value) ? ke.value : null,
                    ($wire.after_hours_saturday_open !== me.value) ? me.value : null,
                    ($wire.after_hours_saturday_close !== be.value) ? be.value : null,
                    ($wire.after_hours_sunday_open !== we.value) ? we.value : null,
                    ($wire.after_hours_sunday_close !== pe.value) ? pe.value : null,
                    ($wire.holiday_hours_monday_open !== ze.value) ? ze.value : null,
                    ($wire.holiday_hours_monday_close !== Ae.value) ? Ae.value : null,
                    ($wire.holiday_hours_tuesday_open !== je.value) ? je.value : null,
                    ($wire.holiday_hours_tuesday_close !== xe.value) ? xe.value : null,
                    ($wire.holiday_hours_wednesday_open !== De.value) ? De.value : null,
                    ($wire.holiday_hours_wednesday_close !== Pe.value) ? Pe.value : null,
                    ($wire.holiday_hours_thursday_open !== Te.value) ? Te.value : null,
                    ($wire.holiday_hours_thursday_close !== Be.value) ? Be.value : null,
                    ($wire.holiday_hours_friday_open !== Ce.value) ? Ce.value : null,
                    ($wire.holiday_hours_friday_close !== Fe.value) ? Fe.value : null,
                    ($wire.holiday_hours_saturday_open !== Ge.value) ? Ge.value : null,
                    ($wire.holiday_hours_saturday_close !== He.value) ? He.value : null,
                    ($wire.holiday_hours_sunday_open !== Ie.value) ? Ie.value : null,
                    ($wire.holiday_hours_sunday_close !== Je.value) ? Je.value : null,
                    ($wire.physical_address_building_number !== Ne.value) ? Ne.value : null,
                    ($wire.physical_address_pre_direction !== Oe.value) ? Oe.value : null,
                    ($wire.physical_address_street_name !== Qe.value) ? Qe.value : null,
                    ($wire.physical_address_street_type !== Re.value) ? Re.value : null,
                    ($wire.physical_address_post_direction !== Ue.value) ? Ue.value : null,
                    ($wire.physical_address_city !== Ye.value) ? Ye.value : null,
                    ($wire.physical_address_state !== Ze.value) ? Ze.value : null,
                    ($wire.physical_address_zip !== ea.value) ? ea.value : null,
                    ($wire.mailing_address_building_number !== la.value) ? la.value : null,
                    ($wire.mailing_address_pre_direction !== va.value) ? va.value : null,
                    ($wire.mailing_address_street_name !== ra.value) ? ra.value : null,
                    ($wire.mailing_address_street_type !== sa.value) ? sa.value : null,
                    ($wire.mailing_address_post_direction !== da.value) ? da.value : null,
                    ($wire.mailing_address_city !== na.value) ? na.value : null,
                    ($wire.mailing_address_state !== ya.value) ? ya.value : null,
                    ($wire.mailing_address_zip !== ia.value) ? ia.value : null,
                    ($wire.remittance_address_building_number !== ka.value) ? ka.value : null,
                    ($wire.remittance_address_pre_direction !== ma.value) ? ma.value : null,
                    ($wire.remittance_address_street_name !== ba.value) ? ba.value : null,
                    ($wire.remittance_address_street_type !== wa.value) ? wa.value : null,
                    ($wire.remittance_address_post_direction !== pa.value) ? pa.value : null,
                    ($wire.remittance_address_city !== ga.value) ? ga.value : null,
                    ($wire.remittance_address_state !== $a.value) ? $a.value : null,
                    ($wire.remittance_address_zip !== Ea.value) ? Ea.value : null;
            });
        })
};
