...
declare const templates: {
    ...
    item({allowHTML, classNames: {item, button, highlightedState, itemSelectable, placeholder,},}: TemplateOptions, {
        id,
        value,
        label,
        customProperties,
    ...
    }: Item, removeItemButton: boolean): HTMLDivElement;
    choiceList({classNames: {list}}: TemplateOptions, isSelectOneElement: boolean): HTMLDivElement;
    choiceGroup({allowHTML, classNames: {group, groupHeading, itemDisabled},}: TemplateOptions, {
        id,
        value,
        disabled
    ...
    choice({
               ...
               selected: isSelected,
               placeholder: isPlaceholder,
           }: Choice, selectText: string): HTMLDivElement;
