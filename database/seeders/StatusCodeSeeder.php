...
class StatusCodeSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('status_codes')->insert([
            ...
            ['for_model' => 'Client', 'code' => 'CLTONB', 'title' => 'Client onboarding', 'default_reason' => 'Client onboarding'],
            ['for_model' => 'Client', 'code' => 'CLTACT', 'title' => 'Client active', 'default_reason' => 'Client activated'],
            ['for_model' => 'Client', 'code' => 'CLTDNU', 'title' => 'Do not use', 'default_reason' => 'Client cannot be used'],
            ['for_model' => 'Vendor', 'code' => 'VENACT', 'title' => 'Vendor active', 'default_reason' => 'Vendor active'],
            ['for_model' => 'Vendor', 'code' => 'VENDNU', 'title' => 'Vendor DNU', 'default_reason' => 'Vendor DNU'],
