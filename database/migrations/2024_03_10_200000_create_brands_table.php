...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('brands', function (Blueprint $table) {
            ...
            $table->string('email_primary', 50)->nullable();
            $table->string('email_ap', 50)->nullable();
            $table->string('email_ar', 50)->nullable();
            $table->string('email_client_relations', 50)->nullable();
            $table->string('email_customer_service', 50)->nullable();
            $table->string('email_projects', 50)->nullable();
            $table->string('email_quoting', 50)->nullable();
            $table->string('email_sales', 50)->nullable();
            ...
            $table->string('mailing_address_unit', 50)->nullable();
            $table->string('mailing_address_unit_type', 50)->nullable();
            ...
            $table->string('remittance_address_unit', 50)->nullable();
            $table->string('remittance_address_unit_type', 50)->nullable();
