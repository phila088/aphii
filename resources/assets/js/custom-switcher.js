...
import {index1, earnings, sparkline8} from './sales-dashboard'
import {crmtotalCustomers, marketCap} from './crypto-dashboard'
import {applicantStats, careerPageStats} from './jobs-dashboard'
import {crmStatistics, dealsSource} from './crm-dashboard'
import {projectstatistics, salesDonut} from './ecommerce-dashboard'
import {analyticsusers, audienceReport, sessionsByDevice, popTrades} from './analytics-dashboard'
import {projectAnalysis} from './projects-dashboard'
import {nftBalane, nftStatistics} from './nft-dashboard'
import {hrmstatistics} from './hrm-dashboard'
import {personalbalance, balance} from './personal-dashboard'
import {stockCap} from './Stock-dashboard'
import {CourseStatistics, payoutsReport} from './Course-dashboard'
import {pageviews} from './widgets'
import {filestore} from './file-store'

import {ResizeMenu, toggleSidemenu, closedSidemenuFn, detachedFn, iconTextFn, iconOverayFn, doubletFn, menuClickFn, menuhoverFn, iconClickFn, iconHoverFn, setNavActive, clearNavDropdown,
...
function updateColors() {
  ...
  if (document.querySelector("#CourseStatistics") !== null) {
    CourseStatistics(myVarVal);
  }
  if (document.querySelector("#payoutsReport") !== null) {
    payoutsReport(myVarVal);
  }
