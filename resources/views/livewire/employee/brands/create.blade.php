...
<div>
    <form wire:submit="store" class="need-validation" novalidate autocomplete="off">
        ...
        <div class="row g-2">
            <p>
                These are the basic settings to create a brand. Adter you have completed all of these steps, you will be
                taken to edit the brand to attach the first address, or phone number, or any of the other properties
                that define the brand. Each setting has a specific use case throughout the application, but most are
                optional.
            </p>
        </div>
        ...
        <div class="row g-2">
            ...
            <dl>
                ...
                <dt>DBA</dt>
                <dl>The name that will be displayed on all forms. If you do not use a DBA, the legal name will be used
                    instead.
                </dl>
                <dt>Abbreviation</dt>
