...
new class extends Component {
    ...
    public function update()
    {
        ...
        if (auth()->user()->client()->update($validated))
        {
            $this->dispatch('toast', message: "Client successfully saved!", type: "success");
            $this->dispatch('client-updated');
        } else {
            $this->dispatch('toast', message: "Client could not be saved.", type: "failure");
        }
    }
    ...
    {
        $this->payment_term_id = $this->client[0]->payment_term_id;
        $this->for_brand = $this->client[0]->for_brand;
        $this->legal_name = $this->client[0]->legal_name;
        $this->dba = $this->client[0]->dba;
        $this->abbreviation = $this->client[0]->abbreviation;
        $this->legal_entity_type = $this->client[0]->legal_entity_type;
        $this->registered_state = $this->client[0]->registered_state;
        $this->onboarding_started = $this->client[0]->onboarding_started;
        $this->onboarding_started_date = $this->client[0]->onboarding_started_date;
        $this->onboarding_finished = $this->client[0]->onboarding_finished;
        $this->onboarding_finished_date = $this->client[0]->onboarding_finished_date;
        $this->vendor_packet_complete = $this->client[0]->vendor_packet_complete;
        $this->vendor_packet_complete_date = $this->client[0]->vendor_packet_complete_date;
        $this->certificate_of_insurance_requested = $this->client[0]->certificate_of_insurance_requested;
        $this->certificate_of_insurance_provided = $this->client[0]->certificate_of_insurance_provided;
        $this->certificate_of_insurance_coverage_start_date = $this->client[0]->certificate_of_insurance_coverage_start_date;
        $this->certificate_of_insurance_coverage_end_date = $this->client[0]->certificate_of_insurance_coverage_end_date;
        $this->workers_comp_requested = $this->client[0]->legal_namworkers_comp_requested;
        $this->workers_comp_provided = $this->client[0]->workers_comp_provided;
        $this->workers_comp_coverage_start_date = $this->client[0]->workers_comp_coverage_start_date;
        $this->workers_comp_coverage_end_date = $this->client[0]->workers_comp_coverage_end_date;
        $this->auto_insurance_requested = $this->client[0]->auto_insurance_requested;
        $this->auto_insurance_provided = $this->client[0]->auto_insurance_provided;
        $this->auto_insurance_coverage_start_date = $this->client[0]->auto_insurance_coverage_start_date;
        $this->auto_insurance_coverage_end_date = $this->client[0]->auto_insurance_coverage_end_date;
        $this->misc_insurance_requested = $this->client[0]->misc_insurance_requested;
        $this->misc_insurance_provided = $this->client[0]->mis_insurance_provided;
        $this->misc_insurance_coverage_start_date = $this->client[0]->misc_insurance_coverage_start_date;
        $this->misc_insurance_coverage_end_date = $this->client[0]->misc_insurance_coverage_end_date;
        $this->accounts_payables_information_verified = $this->client[0]->accounts_payables_information_verified;
        $this->accounts_receivables_information_verified = $this->client[0]->accounts_receivables_information_verified;
        $this->contract_start_date = $this->client[0]->contract_start_date;
        $this->contract_end_date = $this->client[0]->contract_end_date;
        $this->training_materials = $this->client[0]->training_materials;
        $this->ivr_and_onsite_protocol = $this->client[0]->ivr_and_onsite_protocol;
        $this->invoicing_percent_per_invoice = $this->client[0]->invoicing_percent_per_invoice;
        $this->invoicing_amount_per_invoice = $this->client[0]->invoicing_amount_per_invoice;
        $this->invoicing_percent_per_month = $this->client[0]->invoicing_percent_per_month;
        $this->invoicing_amount_per_month = $this->client[0]->invoicing_amount_per_month;
        $this->misc_service_charge_1_description = $this->client[0]->misc_service_charge_1_description;
        $this->misc_service_charge_1_amount = $this->client[0]->misc_service_charge_1_amount;
        $this->misc_service_charge_2_description = $this->client[0]->misc_service_charge_2_description;
        $this->misc_service_charge_2_amount = $this->client[0]->misc_service_charge_2_amount;
        $this->misc_service_charge_3_description = $this->client[0]->misc_service_charge_3_description;
        $this->misc_service_charge_3_amount = $this->client[0]->misc_service_charge_3_amount;
        $this->misc_service_charge_4_description = $this->client[0]->misc_service_charge_4_description;
        $this->misc_service_charge_4_amount = $this->client[0]->misc_service_charge_4_amount;
        $this->misc_service_charge_5_description = $this->client[0]->misc_service_charge_5_description;
        $this->misc_service_charge_5_amount = $this->client[0]->misc_service_charge_5_amount;
        $this->invoicing_required_document_list = $this->client[0]->invoicing_required_document_list;
        $this->invoicing_instructions = $this->client[0]->invoicing_instructions;
        $this->customer_service_phone_1 = $this->client[0]->customer_service_phone_1;
        $this->customer_service_phone_2 = $this->client[0]->customer_service_phone_2;
        $this->customer_service_phone_3 = $this->client[0]->customer_service_phone_3;
        $this->customer_service_phone_4 = $this->client[0]->customer_service_phone_4;
        $this->customer_service_phone_5 = $this->client[0]->customer_service_phone_5;
        $this->customer_service_email_1 = $this->client[0]->customer_service_email_1;
        $this->customer_service_email_2 = $this->client[0]->customer_service_email_2;
        $this->customer_service_email_3 = $this->client[0]->customer_service_email_3;
        $this->customer_service_email_4 = $this->client[0]->customer_service_email_4;
        $this->customer_service_email_5 = $this->client[0]->customer_service_email_5;
        $this->customer_service_fax = $this->client[0]->customer_service_fax;
        $this->invoicing_email_phone_1 = $this->client[0]->invoicing_email_phone_1;
        $this->invoicing_email_phone_2 = $this->client[0]->invoicing_email_phone_2;
        $this->invoicing_email_phone_3 = $this->client[0]->invoicing_email_phone_3;
        $this->invoicing_email_phone_4 = $this->client[0]->invoicing_email_phone_4;
        $this->invoicing_email_phone_5 = $this->client[0]->invoicing_email_phone_5;
        $this->invoicing_email_email_1 = $this->client[0]->invoicing_email_email_1;
        $this->invoicing_email_email_2 = $this->client[0]->invoicing_email_email_2;
        $this->invoicing_email_email_3 = $this->client[0]->invoicing_email_email_3;
        $this->invoicing_email_email_4 = $this->client[0]->invoicing_email_email_4;
        $this->invoicing_email_email_5 = $this->client[0]->invoicing_email_email_5;
        $this->invoicing_email_fax = $this->client[0]->invoicing_email_fax;
        $this->invoicing_fax = $this->client[0]->fax;
        $this->ivr_phone_1 = $this->client[0]->ivr_phone_1;
        $this->ivr_phone_2 = $this->client[0]->ivr_phone_2;
        $this->ivr_phone_3 = $this->client[0]->ivr_phone_3;
        $this->ivr_phone_4 = $this->client[0]->ivr_phone_4;
        $this->ivr_phone_5 = $this->client[0]->ivr_phone_5;
        $this->ivr_email_1 = $this->client[0]->ivr_email_1;
        $this->ivr_email_2 = $this->client[0]->ivr_email_2;
        $this->ivr_email_3 = $this->client[0]->ivr_email_3;
        $this->ivr_email_4 = $this->client[0]->ivr_email_4;
        $this->ivr_email_5 = $this->client[0]->ivr_email_5;
        $this->ivr_fax = $this->client[0]->ivr_fax;
        $this->onsite_phone_1 = $this->client[0]->onsite_phone_1;
        $this->onsite_phone_2 = $this->client[0]->onsite_phone_2;
        $this->onsite_phone_3 = $this->client[0]->onsite_phone_3;
        $this->onsite_phone_4 = $this->client[0]->onsite_phone_4;
        $this->onsite_phone_5 = $this->client[0]->onsite_phone_5;
        $this->onsite_email_1 = $this->client[0]->onsite_email_1;
        $this->onsite_email_2 = $this->client[0]->onsite_email_2;
        $this->onsite_email_3 = $this->client[0]->onsite_email_3;
        $this->onsite_email_4 = $this->client[0]->onsite_email_4;
        $this->onsite_email_5 = $this->client[0]->onsite_email_5;
        $this->onsite_fax = $this->client[0]->onsite_fax;
        $this->remittance_phone_1 = $this->client[0]->remittance_phone_1;
        $this->remittance_phone_2 = $this->client[0]->remittance_phone_2;
        $this->remittance_phone_3 = $this->client[0]->remittance_phone_3;
        $this->remittance_phone_4 = $this->client[0]->remittance_phone_4;
        $this->remittance_phone_5 = $this->client[0]->remittance_phone_5;
        $this->remittance_email_1 = $this->client[0]->remittance_email_1;
        $this->remittance_email_2 = $this->client[0]->remittance_email_2;
        $this->remittance_email_3 = $this->client[0]->remittance_email_3;
        $this->remittance_email_4 = $this->client[0]->remittance_email_4;
        $this->remittance_email_5 = $this->client[0]->remittance_email_5;
        $this->remittance_fax = $this->client[0]->remittance_fax;
        $this->active = $this->client[0]->active;
                    ...
                    <div class="form-floating">
                        ...
                        >
                            ...
                            @foreach ($payment_terms as $payment_term)
                                @if (!empty($this->client->payment_term_id) && $this->client->payment_term_id == $payment_term->id)
                                    <option value="{{ $payment_term->id }}" selected>{{ $payment_term->code }} - {{ $payment_term->title }}</option>
                                @else
