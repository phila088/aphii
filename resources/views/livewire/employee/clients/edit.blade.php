...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $this->status_code = $this->client->status;
        $this->status_reason = $this->client->status()->reason;
        ...
        $this->payment_term_id = $this->client->payment_term_id;
    }
    ...
    public function store(): void
    {
        ...
        if ($this->client->update($validated)) {
            ...
            dd($this->client, $this->status_code, $this->status_reason, $this->client->status()->code);

            if ($this->status_code != $this->client->status()->code || $this->status_reason !== $this->client->status()->reason) {
