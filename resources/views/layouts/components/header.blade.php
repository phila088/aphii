        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                ...
                <div class="main-header-center  d-none d-lg-block  header-link">
                    <input type="text" class="form-control form-control-lg" id="typehead" wire:keydown.slash
        ...
        <div class="header-content-right">
            ...
            <div class="header-element country-selector">
                ...
                <ul class="main-header-dropdown dropdown-menu border-0" data-popper-placement="none">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="{{asset('build/assets/images/flags/germany_flag.jpg')}}"
                                                 alt="img">
                                        </span>
                            German
                        </a>
                ...
                <div class="main-header-dropdown dropdown-menu  border-0 dropdown-menu-end"
                    ...
                    <div class="p-5 empty-item d-none">
                        <div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary btn-wave btn-sm m-1" data-abc="true">continue
                    ...
                    <ul class="list-unstyled mb-0" id="header-notification-scroll">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex  justify-content-between">
                                    <div>
                                        ...
                                        <span
                                            class="fs-12 text-muted fw-normal">Congratulate for New template start</span>
                                    </div>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex  justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-semibold"><a href="javascript:void(0);">Elizabeth Lewis</a>
                                        </p>
            ...
            <div class="offcanvas offcanvas-end wd-330" tabindex="-1" id="apps" aria-labelledby="appsLabel">
                <div class="offcanvas-header border-bottom">
                    ...
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"><i
                            class="bx bx-x   apps-btn-close"></i></button>
                </div>
                <div class="p-3">
                    <div class="row g-3">
                        <div class="col-6">
            ...
            <div class="header-element mainuserProfile">
                        ...
                        <div class="d-sm-flex wd-100p">
                            <div class="avatar avatar-md">
                                @if(!empty($user->profile_picture_path))
                                    <img alt="avatar" class="rounded-circle" src="{{ asset($user->profile_picture_path) }}">
                                @else
                                    <img
                                        alt="avatar"
                                        class="rounded-circle"
                                        src="https://ui-avatars.com/api/?name={{ str_replace(' ', '+', $user->name) }}&background=0D8ABC&color=fff&size=128&rounded=true&bold=true&format=svg" />
                                @endif
                            </div>
                ...
                <ul class="dropdown-menu  border-0 main-header-dropdown  overflow-hidden header-profile-dropdown"
                    ...
                    <li><a class="dropdown-item border-bottom" href="javascript:void(0);"><i
                    ...
                    <li><a id="lock-app" class="dropdown-item border-bottom" href="{{ url('lockscreen') }}"><i
                                class="fs-13 me-2 bx bx-help-circle"></i>Lock</a></li>
