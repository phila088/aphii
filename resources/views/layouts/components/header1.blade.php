                ...
                <div class="horizontal-logo">
                    <a href="javascript:void(0);" class="header-logo">
                        <img src="{{ asset('build/assets/images/brand-logos/logo-full-color-dark-trans.svg') }}" alt="logo"
                             class="desktop-logo">
                        <img src="{{ asset('build/assets/images/brand-logos/logo-icon-color-trans.svg.png') }}" alt="logo"
                             class="toggle-logo">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-sm-flex wd-100p">
                            ...
                            <div class="ms-2 my-auto d-none d-xl-flex">
                                <h6 class=" font-weight-semibold mb-0 fs-13 user-name d-sm-block d-none">Harry
                                    Jones</h6>
                            </div>
                        </div>
                    </div>
