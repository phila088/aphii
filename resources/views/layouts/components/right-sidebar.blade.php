                            ...
                            <ul class="ps-0 vertical-scroll">
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/faces/16.jpg')}}" alt="img"
                                ...
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="img"
                                                    class="avatar avatar-md rounded-2 me-3"></a>
                                            <div class="me-3">
                                                <a href="javascript:void(0);">
                                ...
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="img"
                                                    class="avatar avatar-md rounded-2 me-3"></a>
                                            <div class="me-3">
                                                <a href="javascript:void(0);">
                        ...
                        <div class="tab-pane" id="accepted-1" role="tabpanel">
                            <ul class="activity-list">
                                <li class="d-flex mt-4">
                                    <div>
                                        <i class="activity-icon">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/faces/14.jpg')}}" alt="img"
                                ...
                                <li class="d-flex mt-4">
                                    <div>
                                        <i class="activity-icon">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="img"
                                                    class="avatar avatar-xs rounded-2 me-3"></a>
                                        </i>
                                        <a href="javascript:void(0);">
                                ...
                                <li class="d-flex mt-4">
                                    <div>
                                        ...
                                        <div class="activity-images mt-3">
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/media/media-34.jpg')}}" alt="thumb1"></a>
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/media/media-35.jpg')}}" alt="thumb1"></a>
                                            <a href="javascript:void(0);"><img src="{{asset('build/assets/images/media/media-36.jpg')}}" alt="thumb1"></a>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-flex mt-4">
