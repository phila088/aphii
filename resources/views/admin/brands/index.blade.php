                ...
                <div class="row">
                        ...
                        <div class="card custom-card">
                            <div class="card-body p-4">
                                <div class="card-title">
                                    <h1 class="text-lg">Work Orders By Brand</h1>
                                    <hr class="my-8">
                                </div>
                                <div class="card-body">
                                    <livewire:admin.brands.work-orders-by-brand />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8">
                        <div class="card custom-card">
                            <div class="card-body p-4">
                                <div class="card-title">
                                    <h1 class="text-lg">Invoicing By Brand</h1>
                                    <hr class="my-8">
                                </div>
                                <div class="card-body">
                                    <livewire:admin.brands.invoice-by-brand />
                                </div>
                            </div>
                        </div>
                    </div>
